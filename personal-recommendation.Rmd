...
for (person_id in 1:1) {
  ...
  intake_proposals.df$boundsmet <- result$softbound_sum
  ...
  colnames(intake_proposals.df) <- c("proposal", "lp", "preference", "boundsmet", queried_nodes)
...
ggplot(accepted_intake.df) +
      geom_point(aes(y=lp, x=boundsmet))

recommendation_intake.df$boundsmet
