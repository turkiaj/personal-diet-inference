...
subjects_with_failed_concs <- readRDS("patient_summary/sysdimet/gamma_qr_mv/simulation",simulation,"/recommendation_summary_with_concpreds_and_current.rds")
...
intake.df <- readRDS("patient_summary/sysdimet/gamma_qr_mv/simulation",simulation,"/recommendation_summary_with_concpreds_and_current.rds")
...
p <- ggplot(cumulative_concs) +
   ...
   scale_linewidth_continuous(range = c(0.5, 1.0))  +
...
#ggsave("figures/sysdimet_diet_strategies_lowEPA.pdf", plot = p)
