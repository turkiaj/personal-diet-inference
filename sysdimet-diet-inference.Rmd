...
effect_summary[effect_summary$effect=="epa_fshdl",]
...
p <- ggplot(cumulative_concs) +
   geom_point(aes(x = predicted_concentration, y = nutrient, color = subject_id), size = 0.7, show.legend = FALSE) +
...
# kable(strategy_summary.df, "latex", escape = F, booktabs = T, row.names = FALSE, digits = 2,align="lccc",
#   col.names = c("Nutrient", "Avg", "Min-Max", "SD", "Avg", "Min-Max", "SD", "Avg", "Min-Max", "SD", "Avg", "Min-Max", "SD", "Avg", "Min-Max", "SD")) %>%
#   add_header_above(c(" " = 1, "Contribution to fS-HDL" = 3, "fS-LDL" = 3, "fS-Ins" = 3, "fS-Chol" = 3, "fp-Gluc" = 3), escape = F) %>%
#   column_spec(1, width = "7em") %>%
#   kable_styling(latex_options="scale_down") %>%  
#   kable_styling(latex_options = c("basic", "condensed"), full_width = TRUE) %>%
#   row_spec(0,bold=TRUE) %>%
