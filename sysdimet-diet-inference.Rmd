...
conc_plot1 <- ggplot(recommendation_intake.df) +
  geom_point(aes(y=lp, x=fshdl, color=preference), show.legend=TRUE) +
...
sysdimet_lp_plots <- function(subject_code_vector, plot_path) {
  ...
  normal_palette <- "#00337C"
  failed_palette <- "#FF6961"
  low_color <- "#EEEEEE"
  ...
  for (subject_code in subject_code_vector[1:(persons-1)]) {
      ...
      conc_plot1 <- ggplot(accepted_intake.df) +
        ...
        scale_colour_gradient(low=low_color, high=if (fshdl_accepted) normal_palette else failed_palette) +
        theme_bw() +
        theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
        theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
        labs(x = element_blank(), y = person_id)
      ...
      conc_plot2 <- ggplot(accepted_intake.df) +
        ...
        scale_colour_gradient(low=low_color, high=if (fsldl_accepted) normal_palette else failed_palette) +
        theme_bw() +
        theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
        theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
      ...
      conc_plot3 <- ggplot(accepted_intake.df) +
        ...
        scale_colour_gradient(low=low_color, high=if (fsins_accepted) normal_palette else failed_palette) +
        theme_bw() +
        theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
        theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
        labs(x = element_blank(), y = element_blank())
      ...
      conc_plot4 <- ggplot(accepted_intake.df) +
        ...
        scale_colour_gradient(low=low_color, high=if (fskol_accepted) normal_palette else failed_palette) +
        theme_bw() +
        theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
        theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
        labs(x = element_blank(), y = element_blank())
      ...
      conc_plot5 <- ggplot(accepted_intake.df) +
        ...
        scale_colour_gradient(low=low_color, high=if (fpgluk_accepted) normal_palette else failed_palette) +
        theme_bw() +
        theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
        theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
        labs(x = element_blank(), y = element_blank())
  ...
  conc_plot1 <- ggplot(accepted_intake.df) +
    ...
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
    labs(x = "fS-HDL (mmol/l)", y = person_id)
  ...
  conc_plot4 <- ggplot(accepted_intake.df) +
    ...
    annotate("rect",ymin=-Inf, ymax=Inf, xmin=fskol_recommendations[2], xmax=Inf, alpha = .2) + 
    scale_x_continuous(limits=c(fskol_scale_min, fskol_scale_max), breaks=fskol_recommendations) +
    scale_color_gradientn(colours = if (fskol_accepted) normal_palette else failed_palette) +
    scale_colour_gradient(low=low_color, high=if (fskol_accepted) normal_palette else failed_palette) +
    theme_bw() +
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    theme(axis.text.y = element_blank(), axis.ticks.y = element_blank()) +
