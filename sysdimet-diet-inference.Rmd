...
```{r fig.height=8, inference_debug}
    conc_plot1 <- ggplot(accepted_intake.df) +
      geom_point(aes(y=lp, x=fshdl_mu, color=preference), show.legend=TRUE) +
