...
for (person_id in 1:length(kontrolli)) {
  ...
  if (check_failed_concs(graph_person_id, personal_info, recommeded_concentrations) == TRUE) { 
      ...
      # now failing
      # 121,12,108,40
      #if (graph_person_id == 121 || graph_person_id == 12 || graph_person_id == 108 || graph_person_id == 40)
      #{
      #   l1 <- 6
      #   l3 <- 10
      #   l5 <- 1
      ...
      if (graph_person_id == 5)
      {
        l1 <- 4 
      }
      
      # - more loose preference for special cases
      if (graph_person_id == 127 || graph_person_id == 40 || graph_person_id == 12 || graph_person_id == 121 || graph_person_id == 5)
      {
         l3 <- 7
         l5 <- 1.0
      }
      ...
      intake_model <- mebn.Query(reaction_graph = personal_graph,
                               ...
                               repeat_only = 0,
                               verbose = 1,
                               l1 = l1,     # limit_steepness: Steepness parameter for individual soft bounds
